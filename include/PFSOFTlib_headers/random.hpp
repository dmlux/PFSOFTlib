...
#ifndef PFSOFTlib_random_hpp
#define PFSOFTlib_random_hpp
...
{
    pfsoft_cond_w_ret(min > max, "%s", "min value is greater than max value in rand function for complex vectors.");
